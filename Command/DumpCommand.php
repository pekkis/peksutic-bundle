...
namespace Pekkis\PeksuticBundle\Command;

use Assetic\Asset\AssetInterface;
use Assetic\AssetManager;
use Pekkis\PeksuticBundle\Service\AssetizerService;
...
class DumpCommand extends ContainerAwareCommand
{
    ...
    {
        $this
            ->setName('peksutic:dump')
            ->setDescription('Dumps all peksutic assets to the filesystem')
    ...
    protected function initialize(InputInterface $input, OutputInterface $output)
    {
        ...
        $this->am = $this->getContainer()->get('pekkis_peksutic.asset_manager');
        
        $this->assetizer = $this->getContainer()->get('pekkis_peksutic.service.assetizer');
